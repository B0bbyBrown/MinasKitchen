...
export default function ChallengeSection() {
  ...
  const currentAmount = stats?.total || 25000;
  const challengePercentage = Math.min((currentAmount / challengeGoal) * 100, 100);
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-secondary to-accent" id="challenge">
        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Help us reach our first major milestone! When we hit R150,000, we'll unlock:
            </motion.p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              >
                ...
                <h3 className="font-semibold text-lg mb-2">Professional Kitchen Setup</h3>
                <p className="text-sm opacity-90">Start building our permanent kitchen facility</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm opacity-90">Professional kitchen training for our team</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm opacity-90">Expand to feeding children during weekdays</p>
              </motion.div>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-3">
                ...
                <span className="font-bold">
                  R {currentAmount.toLocaleString()} / R {challengeGoal.toLocaleString()}
                </span>
              </div>

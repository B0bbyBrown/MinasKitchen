        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Your donation directly feeds children and empowers women in
              Smutsville. Choose an amount that works for you.
            </p>
          </motion.div>
            ...
            {amountOptions.map((option, index) => (
              ...
              >
                <div className="text-center">
                  ...
                  {option.isPopular && (
                    <div className="bg-primary text-white text-xs px-2 py-1 rounded-full mt-2">
                      Average
                    </div>
                  )}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Provide consistent support with automatic monthly donations.
                Cancel anytime.
              </p>
              <ul className="space-y-2 text-sm text-gray-600 mb-4">
                <li>
                  <Check className="inline text-success mr-2 w-4 h-4" />
                  Reliable funding for meal planning
                </li>
                <li>
                  <Check className="inline text-success mr-2 w-4 h-4" />
                  Priority updates on our progress
                </li>
                <li>
                  <Check className="inline text-success mr-2 w-4 h-4" />
            ...
            >
              ...
              <ul className="space-y-2 text-sm text-gray-600 mb-4">
                <li>
                  <Check className="inline text-primary mr-2 w-4 h-4" />
                  Instant impact on our community
                </li>
                <li>
                  <Check className="inline text-primary mr-2 w-4 h-4" />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="font-bold text-2xl text-neutral mb-6 text-center">
              How You Can Help
            </h3>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  Industrial ovens, pots, pans, and serving equipment
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  Reliable transport for supplies and equipment
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  Accounting, marketing, legal, and training support
                </p>
              </motion.div>
            </div>
          </motion.div>
